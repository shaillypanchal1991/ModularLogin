package com.sample.loginmodule.storage;
...
public final class CustomEncryptedPreferences {
     ...
     */
    @Deprecated
    public static void initPrefs(Context context) throws GeneralSecurityException, IOException {
        new Builder().setContext(context).build();
    }

    private static void initPrefs(Context context, String prefsName, int mode) throws GeneralSecurityException, IOException {
    ...
    public static void encryptAndStore(String key,Login data) {
        if (TextUtils.isEmpty(data.toString()))

            //(3) Store text in sharepreferences as normally done
            //data will be encrypted as its stored
            mPrefs.edit().putString(key, data.toString()).apply();


    }
    private String decryptAndShow(String key) {
    ...
    public final static class Builder {
        ...
        public void build() throws GeneralSecurityException, IOException {
            ...
            CustomEncryptedPreferences.initPrefs(mContext, mKey, mMode);
        }
